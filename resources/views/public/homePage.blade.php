            ...
            <div class="grid xl:grid-cols-3 gap-12">
                <div class="relative flex flex-col min-w-0 break-words w-full shadow-lg rounded-lg bg-black dark:bg-white border-gray-700">
                    ...
                    <blockquote class="relative p-6 mb-4">
                        <svg preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 583 95" class="absolute left-0 w-full block" style="height:65px;top:-64px">
                        ...
                        <p class="text-base h-fit font-light mt-2 dark:text-slate-700 text-white">
                        {{__('2D & 3D motion design services bring your ideas to life. Our professional designers create stunning visuals to convey your message and tell your story.')}}
                        </p>
                        <div class="w-full flex justify-center mt-4">
                            <a href="{{route('motion')}}" class="bt btn-primary">{{__('See more')}}</a>
                        </div>
                    </blockquote>
                </div>
                <div class="relative flex flex-col min-w-0 break-words w-full shadow-lg rounded-lg bg-black dark:bg-white border-gray-700">
                    ...
                    <blockquote class="relative p-6 mb-4">
                        ...
                        <div class="w-full flex justify-center mt-4">
                            <a href="{{route('dev')}}" class="bt btn-primary">{{__('See more')}}</a>
                        </div>
                    </blockquote>
                </div>
                <div class="relative flex flex-col min-w-0 break-words w-full shadow-lg rounded-lg bg-black dark:bg-white border border-gray-700">
                    ...
                    <blockquote class="relative p-6 mb-4">
                        ...
                        <div class="w-full flex justify-center mt-4">
                            <a href="{{route('visuals')}}" class="bt btn-primary">{{__('See more')}}</a>
                        </div>
                    </blockquote>
                </div>
            </div>
