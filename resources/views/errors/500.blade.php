<x-layout.errors title="{{__('Server Error')}}">
            ...
            <div class="row justify-content-center">
                <div class="text-center relative z-100">
                    ...
                    <p class="lead my-7 text-dark dark:text-gray-300">
                        {{__('The page you are trying to view is currently unavailable due to an internal server error. We apologize for any inconvenience. You can return to the homepage if you wish.')}}
                    </p>
