<div  x-data="{ modal: false }" x-on:close-modal.window="modal = false">
    <div class="max-w-sm mx-auto flex justify-center my-12">
        <button type="button"  x-on:click="modal = ! modal"  class="w-full py-3 px-6 dark:bg-yellow-500 dark:text-dark text-white hover:bg-opacity-80 bg-dark rounded-full">{{__('Get quote')}}</button>
    </div>
    <div class="mx-auto" wire:ignore>
        <div x-show="modal"  class="font-sans antialiased fixed xl:top-0 lg:top-0 top-20 right-0 left-0 inset-x-0 px-4 pb-4 sm:inset-0 sm:flex sm:items-center sm:justify-center z-50">
            <div x-show="modal" x-transition:enter="ease-out duration-300"  x-cloak x-transition:enter-start="opacity-0"
                 x-transition:enter-end="opacity-100" x-transition:leave="ease-in duration-200"
                 x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0"
                 class="fixed inset-0 transition-opacity">
                <div class="absolute inset-0 bg-slate-700 shadow opacity-75 z-50"></div>
            </div>
            <div x-show="modal" x-transition:enter="ease-out duration-300"
                 ...
                 class="bg-white h-fit rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-2xl sm:w-full" x-cloak>
                <div class="dark:bg-slate-900 dark:border-slate-900 bg-white h-fit px-8 py-4 relative rounded-md border shadow-lg" x-cloak>
                    ...
                    <div class="flex items-center text-center">
                        <div class="my-5 text-center sm:mt-0 sm:ml-4 sm:text-center w-full">
                            <h3 class="dark:text-white text-xl uppercase leading-6 font-semibold text-sandstone my-4">Get quotation</h3>
                            <form wire:submit.prevent="SaveQuote">
                                <div class="w-full pt-6">
                                    <div class="mb-4">
                                        <input type="text" wire:model="name" class="form-control" id="name" placeholder="{{__('Full Name')}}">
                                    </div>
                                    ...
                                    <div class="p-3 mb-6">
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            <div class="flex items-center">
                                                ...
                                                <label for="checkbox-1" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Website </label>
                                            </div>
                                            <div class="flex items-center">
                                                ...
                                                <label for="checkbox-2" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Web Application</label>
                                            </div>
                                            <div class="flex items-center">
                                                ...
                                                <label for="checkbox-3" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Saas Project</label>
                                            </div>
                                            <div class="flex items-center">
                                                ...
                                                <label for="checkbox-4" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Mobile Application</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-4 relative" x-data="{currency : 'USD',displayDropdown : false}">
                                        <input type="number" wire:model.defer="budget" class="form-control" id="subject" placeholder="{{__('Budget ( USD )')}}">
                                        ...
                                        <div class="absolute right-0 transition duration-300 ease-in-out" x-show="displayDropdown">
                                            <div type="button"  @click.prevent="currency = 'USD' ;displayDropdown  =! displayDropdown" class="text-center w-24 pl-4 h-full py-1.5 cursor-pointer hover:bg-slate-100 flex items-center border border-gray-200 bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100">
                                                USD
                                            </div>
                                            <div type="button"  @click.prevent="currency = 'EUR' ;displayDropdown  =! displayDropdown" class="text-center w-24 pl-4 h-full py-1.5 cursor-pointer hover:bg-slate-100 flex items-center border border-gray-200 bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100">
                                                EUR
                                            </div>
                                            <div type="button"  @click.prevent="currency = 'DZD' ;displayDropdown  =! displayDropdown" class="text-center w-24 pl-4 h-full py-1.5 cursor-pointer hover:bg-slate-100 flex items-center border border-gray-200 bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-100">
                                                DZD
                                            </div>
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <textarea class="form-control" wire:model="additional" rows="3" placeholder="{{__('Additional information')}}"></textarea>
                                    </div>
