<header class="z-50 fixed top-0 border-b border-slate-200 dark:border-slate-800 w-full bg-white dark:bg-gray-900 duration-200 transition-colors">
    <div class="xl:px-12 mx-auto xl:flex hidden h-16">
