        ...
        <nav class="sidebar " >
            <div class="navbar-collapse z-50" id="navbar-collapse">
                ...
                <ul class="xl:pt-4 pt-16 px-0">
                    <li class="py-3 {{ config('app.locale') == 'ar' ? "pl-2" : 'pr-2' }} hover:bg-gray-200 dark:hover:bg-gray-700"><a href="{{route('visuals')}}" title="Visuals" class="text-base {{ Route::currentRouteName() == 'visuals' ? 'font-bold text-black dark:text-white' : 'text-gray-800 dark:text-gray-100' }}"><i class="fa fa-image mx-2"></i> Visuals</a></li>
                    <li class="py-3 {{ config('app.locale') == 'ar' ? "pl-2" : 'pr-2' }} hover:bg-gray-200 dark:hover:bg-gray-700"><a href="{{route('motion')}}" title="Motions" class="text-base {{ Route::currentRouteName() == 'motion' ? 'font-bold text-black dark:text-white' : 'text-gray-800 dark:text-gray-100' }}"><i class="fa fa-spinner mx-2"></i> Motions</a></li>
                    <li class="py-3 {{ config('app.locale') == 'ar' ? "pl-2" : 'pr-2' }} hover:bg-gray-200 dark:hover:bg-gray-700"><a href="{{route('dev')}}" title="Development" class="text-base {{ Route::currentRouteName() == 'dev' ? 'font-bold text-black dark:text-white' : 'text-gray-800 dark:text-gray-100' }}"><i class="fa fa-code mx-2"></i> Development</a></li>
                    <li class="py-3 {{ config('app.locale') == 'ar' ? "pl-2" : 'pr-2' }} hover:bg-gray-200 dark:hover:bg-gray-700"><a href="{{route('animation')}}" title="Development" class="text-base {{ Route::currentRouteName() == 'animation' ? 'font-bold text-black dark:text-white' : 'text-gray-800 dark:text-gray-100' }}"><i class="fa fa-cube mx-2"></i>3D & Rendering</a></li>
                    <li class="py-3 {{ config('app.locale') == 'ar' ? "pl-2" : 'pr-2' }} hover:bg-gray-200 dark:hover:bg-gray-700"><a href="{{route('services')}}" class="text-base dark:text-gray-100 {{ Route::currentRouteName() == 'services' ? 'font-bold text-black dark:text-white' : 'text-gray-800 dark:text-gray-100'  }}"><i class="fa fa-handshake-o mx-2"></i> Services</a></li>
                    <li class="py-3 {{ config('app.locale') == 'ar' ? "pl-2" : 'pr-2' }} hover:bg-gray-200 dark:hover:bg-gray-700"><a href="{{route('contact')}}" title="Contact" class="text-base {{ Route::currentRouteName() == 'contact' ? 'font-bold text-black dark:text-white' : 'text-gray-800 dark:text-gray-100' }}" ><i class="fa fa-envelope mx-2"></i> Contact Us</a></li>
                </ul>
