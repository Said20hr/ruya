<div class="dark:bg-dark ">
    ...
    <header class="xl:hidden border-r fixed left-O top-0 xl:max-w-52 w-1/2 py-4 xl:px-6 px-4 h-full z-50 transition-all ease-soft-in-out duration-600 dark:bg-gray-900 bg-white border-slate-200 dark:border-slate-800"
        ...
        <nav class="sidebar " >
            <div class="navbar-collapse z-50" id="navbar-collapse">
                ...
                <ul class="xl:pt-4 pt-16 px-0">
                    <li class="py-3 px-2 hover:bg-gray-200 dark:hover:bg-gray-700"><a href="{{route('visuals')}}" title="Visuals" class="text-base {{ Route::currentRouteName() == 'visuals' ? 'font-bold text-black dark:text-white' : 'text-gray-800 dark:text-gray-100' }}"><i class="fa fa-image mr-2"></i> Visuals</a></li>
                    <li class="py-3 px-2 hover:bg-gray-200 dark:hover:bg-gray-700"><a href="{{route('motion')}}" title="Motions" class="text-base {{ Route::currentRouteName() == 'motion' ? 'font-bold text-black dark:text-white' : 'text-gray-800 dark:text-gray-100' }}"><i class="fa fa-spinner mr-2"></i> Motions</a></li>
                    <li class="py-3 px-2 hover:bg-gray-200 dark:hover:bg-gray-700"><a href="{{route('dev')}}" title="Development" class="text-base {{ Route::currentRouteName() == 'dev' ? 'font-bold text-black dark:text-white' : 'text-gray-800 dark:text-gray-100' }}"><i class="fa fa-code mr-2"></i> Development</a></li>
                    <li class="py-3 px-2 hover:bg-gray-200 dark:hover:bg-gray-700"><a href="{{route('animation')}}" title="Development" class="text-base {{ Route::currentRouteName() == 'animation' ? 'font-bold text-black dark:text-white' : 'text-gray-800 dark:text-gray-100' }}"><i class="fa fa-cube mr-2"></i>3D Animation</a></li>
                    <li class="py-3 px-2 hover:bg-gray-200 dark:hover:bg-gray-700"><a href="#" title="services" class="text-base dark:text-gray-100 {{ Route::currentRouteName() == 'services' ? 'font-bold' : '' }}"><i class="fa fa-handshake-o mr-2"></i> Services</a></li>
                    <li class="py-3 px-2 hover:bg-gray-200 dark:hover:bg-gray-700"><a href="{{route('contact')}}" title="Contact" class="text-base {{ Route::currentRouteName() == 'contact' ? 'font-bold text-black dark:text-white' : 'text-gray-800 dark:text-gray-100' }}" ><i class="fa fa-envelope mr-2"></i> Contact Us</a></li>
                </ul>
    ...
    <!-- Large Screen -->
    <header class="hidden xl:fixed xl:flex left-O top-0 xl:max-w-56 w-1/2 py-4 xl:px-6 px-4 dark:bg-gray-900 duration-200 transition-colors bg-white h-full border-r border-slate-200 dark:border-slate-800">
        <nav class="sidebar" >
